...
class Gaussian(Distribution):
    ...
    def calculate_mean(self):
        ...
        self.mean = math.fsum(self.data) / len(self.data)
    ...
    def calculate_stdev(self, sample:bool=True):
        ...
        """
        Calculate Standard Daviation of the data
        ...
        for x in self.data:
            sum_of_square += math.pow( x - mean , 2)
        

        self.stdev =  float( math.sqrt(sum_of_square / N) )
